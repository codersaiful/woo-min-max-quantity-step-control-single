...
WooCommerce Min Max Quantity & Step Control Single  plugin offers to set product's minimum, maximum quantity and step for all product individually.
...
1. Upload the plugin files to the `/wp-content/plugins/WC_Min_Max_Quantity_Global` directory, or install the plugin through the WordPress plugins screen directly.
...
Very easy. Just go to WooCommerce -> Min Max & Step
