...
if ( $max_value && $min_value === $max_value ) {
	...
	<div class="qib-button wcmmq_qib_button">
		...
		<label class="screen-reader-text" for="wcmmq_<?php esc_attr_e( uniqid( 'quantity_' ) ); ?>"><?php esc_html_e( 'Quantity', 'wcmmq' ); ?></label>
                ...
                <div class="quantity">
                    ...
                    title="<?php echo esc_attr_x( 'Qty', 'Product quantity input tooltip', 'wcmmq' ); ?>"
